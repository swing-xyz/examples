            ...
            <nav>
                <Container className="relative z-50 flex justify-between py-8">
                    ...
                    <div className="flex items-center gap-6">
                        <Popover className="lg:hidden">
                            {({ open }) => (
                                <>
                                    ...
                                    >
                                        {({ open }) => (open ? <ChevronUpIcon className="w-6 h-6" /> : <MenuIcon className="w-6 h-6" />)}
                                    </Popover.Button>
                        ...
                        <Button href="https://github.com/swing-xyz/examples" className="hidden space-x-2 lg:block" variant="outline">
                            <FontAwesomeIcon size="lg" icon={faGithub} />
                            <span>Fork on Github</span>
                        </Button>

    ...
    <div className="py-20 overflow-hidden sm:py-32 lg:pb-32 xl:pb-36">
      <Container>
        <div className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 -z-10">
          <CircleBackground color="#a29bfe" className="animate-spin-slower" />
        </div>
        <div className="flex flex-col justify-center items-center mb-10 gap-5">
              <p className="bg-gray-800 rounded-3xl w-auto px-3 py-2 font-bold text-[11px]">RapidPay API V3 is live 🎉</p>
        ...
        <Tabs defaultValue="deposit" className="w-[40%]">
          <TabsList className="grid w-full grid-cols-2 bg-zinc-900">
            <TabsTrigger value="deposit">Bridge</TabsTrigger>
            <TabsTrigger value="withdraw" disabled>Stake (Coming Soon)</TabsTrigger>
          </TabsList>

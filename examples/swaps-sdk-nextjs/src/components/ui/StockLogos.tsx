export function LaravelLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" className={className}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export function TupleLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" className={className}>
      <path
        fillRule="evenodd"
...
export function TransistorLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" className={className}>
...
export function DiageoLogo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="#fff"
...
export function StaticKitLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" className={className}>
...
export function StatamicLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" className={className}>
      <path
        fillRule="evenodd"
...
export function MirageLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" className={className}>
      <path
        fillRule="evenodd"
...
export function ReversableLogo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="none"
